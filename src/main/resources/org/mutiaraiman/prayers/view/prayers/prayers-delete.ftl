		...
		<div class="row">
			<div class="span12">
				...
				<ul class="nav nav-tabs nav-stacked">
					...
					<li>
						<a href="${m.id}/delete" onclick="return confirm('<@s.text name="message.confirm.delete" /> &nbsp;${m.title}?');" value="Show a confirm box">${m.title} <i class="icon-trash" style="float: right;"></i></a>
					</li>
					</#list>
				</ul>
			</div>
