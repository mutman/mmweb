...
@Results({
    ...
    @Result(name = DefaultAction.NEW, type = "freemarker", location = "/org/mutiaraiman/prayers/view/quote/quote-add.ftl"),
    ...
    @Result(name = DefaultAction.SUCCESS, type = "redirectAction", location = "quote/delete") })

public class QuoteAction extends DefaultPrayerController {

    private static final long serialVersionUID = -1063904531478171378L;
    
    private static final Log log = LogFactory.getLog(QuoteAction.class);
