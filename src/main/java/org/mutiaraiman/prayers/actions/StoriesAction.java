...
@Results({
    ...
    @Result(name = DefaultAction.NEW, type = "freemarker", location = "/org/mutiaraiman/prayers/view/stories/stories-add.ftl"),
    ...
    @Result(name = DefaultAction.SUCCESS, type = "redirectAction", location = "stories/delete") })

public class StoriesAction extends DefaultPrayerController {

    private static final long serialVersionUID = -1063904531478171378L;
    
    private static final Log log = LogFactory.getLog(StoriesAction.class);
